  ...
  <div :class="$style.container">
    ...
    <div class="mt-8">
      ...
      <ul :class="$style.notes">
        <li>The selected payment method will be billed the total amount for the subscription immediately.</li>
        <li>New billing cycle starts at UTC midnight after the subscription has ran out.</li>
        <li>An invoice is generated for each payment and you can access it from your account page.</li>
        <li>Subscriptions can be canceled from the account page at any point in time.</li>
      </ul>
    </div>
  </div>
</template>
