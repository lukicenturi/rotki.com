...
<template>
  ...
  <div class="mt-16">
    <RuiButton color="primary" class="w-full" size="lg" @click="emit('next')">
      Continue
    </RuiButton>
  </div>
</template>
